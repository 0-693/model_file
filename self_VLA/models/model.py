...
from shared import image_tools
import shared.array_typing as at
import numpy as np

logger = logging.getLogger("openpi")

# ArrayT = TypeVar("ArrayT", at.Array, jax.ShapeDtypeStruct)
ArrayT   = TypeVar("ArrayT", bound=Array)  # 给 Generic 用
ArrayCls = Array                           # 给 at.Float 用
...
Actions = at.Float[ArrayCls, "*b ah ad"]
